module.exports = ({
  ...
  Başvuru kanalı başarı ile $replaceText[$replaceText[$message[1];ayarla;<#$mentionedChannels[1;yes]> olarak ayarlandı;1];sıfırla;sıfırlandı;1] ! 
   $onlyIf[$checkContains[$message[1];ayarla;sıfırla]==true;{title:HATA}{description:Lütfen $getServerVar[prefix]başvuru-kanal ayarla veya $getServerVar[prefix]başvuru-kanal sıfırla yazınız}{color:ff0000}] 
$onlyIf[$hasPerms[$authorID;admin]!=false;{title:HATA}{description:Bu komutu lullanmak için \`Yönetici\` yetkin olmalı!}{color:ff0000}]` 
})
